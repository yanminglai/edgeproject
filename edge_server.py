...
class Edge_Node:
    def __init__(self, max_resource, eps):
        ...
        self.record_ts = []
        self.record_runtask = []
    def initialize_queue(self, size):
...
def _init():
    global _edge_server
    _edge_server = Edge_Node(max_resource=200, eps=0.5)

def init_task_queue(size):
    return _edge_server.initialize_queue(size)
